  ...
  return (
    <Section narrow>
      <SubscriptionContainer>
        <Content>
          <Heading>
            Welcome to Bean Musing!
          </Heading>
          <Text>
            Featuring money stories and occassional hot takes on conventional wisdom.
            Join my mailing list and opt-out at anytime. I won't spam, I promise. 
          </Text>
